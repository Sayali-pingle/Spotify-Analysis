...
server <- function(input, output) {
  ...
  observeEvent(input$analyze_button, {
    ...
    tryCatch({
      # Use environment variables instead of input values
      ...
      result <- artist_details(input$artist_name, Sys.getenv("SPOTIFY_CLIENT_ID"), Sys.getenv("SPOTIFY_CLIENT_SECRET"))
      ...
      if (!is.null(result$artist_id)) {
        ...
        # Add similar value boxes for danceability, liveness, and duration
    ...
    error = function(e) {
      showNotification(
        "Error accessing Spotify API. Please try again.",
        type = "error"
      )
    })
